...
<div class="container-fluid">
  ...
  <form class= "FormularioAjax form-neon" action="<?php echo SERVER_URL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
    ...
    <fieldset>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if($_SESSION['privilegio_smp'] == 1 && $campos['usuario_id']!=1){ ?>
          <div class="col-12">
            <div class="form-group">
          ...
          <div class="col-12">
            ...
            <div class="form-group">
              <select class="form-control" name="usuario_privilegio_up">                                
                ...
                <option value="3" <?php if($campos['usuario_privilegio']==3){ echo 'selected=""'; } ?>>Buscar <?php if($campos['usuario_privilegio']==3){ echo '(Actual)'; } ?></option>
              </select>
            </div>
          </div>
        </div>
    ...
    <br><br><br>
    <fieldset>
      <p class="text-center text-danger"><strong>Para poder guardar los cambios en esta cuenta debe de ingresar su nombre de usuario y contraseña</strong></p>
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="form-group">
